...
public class Game {
    ...
    public void init(AbstractEntityFactory factory) {
        ...
        this.base      = factory.createBase(900, 450);
        stopwatch.reset();
    }
    ...
    public void tick() {
        ...
        // Les tours cherchent et attaquent une cible (Streams API)
        ...
        // Vérification état
        if (!base.isAlive())        state = State.GAME_OVER;
        else if (enemies.isEmpty()) state = State.VICTORY;
    }
